...
export interface CueCanvasAPIClient extends grpc.Client {
...
export interface CueCanvasAPIHandlers extends grpc.UntypedServiceImplementation {
  ShowShots: grpc.handleUnaryCall<_protobuf_ShowShotsRequest__Output, _google_protobuf_Empty>;
  
}

export interface CueCanvasAPIDefinition extends grpc.ServiceDefinition {
